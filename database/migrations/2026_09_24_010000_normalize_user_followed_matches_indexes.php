...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if ($this->indexExists('user_followed_matches', 'user_followed_matches_fixture_id_status_short_index')) {
            Schema::table('user_followed_matches', function (Blueprint $table) {
                $table->dropIndex('user_followed_matches_fixture_id_status_short_index');
            });
        }
    ...
    public function down(): void
    {
        ...
        if ($this->indexExists('user_followed_matches', 'ufm_fixture_status_idx')) {
            Schema::table('user_followed_matches', function (Blueprint $table) {
                $table->dropIndex('ufm_fixture_status_idx');
            });
        }
    }
